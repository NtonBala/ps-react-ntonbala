...
Project package manager is `npm`, to run project install dependencies via `npm install` and run `npm run start` command.
...
By default open [http://localhost:3000](http://localhost:3000) to view it in your browser.
